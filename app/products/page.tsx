...
const groups: ProductGroup[] = [
  {
    ...
    products: [
      ...
      { code: "STORE", title: "WooCommerce Hosting", text: "A WordPress commerce path for online stores that need stronger caching, backup, and growth options.", status: "Available by configuration", href: "/hosting/wordpress" },
  ...
  },
  {
    ...
    products: [
      { code: "TURBO", title: "Website Turbo", text: "High-frequency hosting acceleration for demanding or traffic-sensitive sites that need additional compute performance.", status: "Performance add-on", href: "/security" },
      { code: "SSL+", title: "Premium SSL Certificates", text: "Paid certificate options for customers who need a certificate product beyond standard included HTTPS.", status: "Optional add-on", href: "/security" },
      { code: "BACKUP+", title: "Timeline Backups Pro", text: "Extended snapshot-style recovery for customers who want a deeper backup history and additional restore flexibility.", status: "Optional add-on", href: "/security" },
      { code: "CLEAN", title: "Malware Cleanup & Recovery", text: "Hands-on assistance when a site needs investigation, cleanup, restoration, or recovery after a security incident.", status: "Request service", href: "/support" },
      { code: "CARE", title: "Website Care", text: "Ongoing help with routine website maintenance, updates, recovery planning, and operational upkeep.", status: "Request service", href: "/support" },
  ...
  },
  {
    ...
    products: [
      ...
      { code: "MAIL+", title: "Mailbox Storage Upgrades", text: "Add mailbox storage when a customer needs more email capacity without upgrading website hosting.", status: "Optional add-on", href: "/email" },
  ...
  },
  {
    ...
    products: [
      ...
      { code: "SETUP", title: "Website Setup Service", text: "Assisted setup for customers who have a domain and content but do not want to configure the hosting environment themselves.", status: "Request service", href: "/support" },
      { code: "ECOM", title: "Ecommerce Setup", text: "Configuration help for store-focused WordPress and cloud workloads, including the hosting path and launch environment.", status: "Request service", href: "/support" },
